    ...
    return (
        <SafeAreaView>
            ...
            <ScrollView style={styles.container}>
                ...
                <EditableBox label='Name' onChangeText={v => onChange('fullName', v)} value={"test"} editable={editing} />
                <EditableBox label='Email' onChangeText={v => onChange('email', v)} value={"test@gmail.com"} editable={editing} />
                {editing ? (
